...
# Mirrors webui/Main.py's DEFAULT_SUBTITLE_SETTINGS. Duplicated here (rather
# than imported) because webui/Main.py runs `_render_application()` at
# import time and isn't safe to import from a non-Streamlit process.
